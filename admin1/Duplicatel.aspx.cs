...
public partial class admin_Duplicatel : System.Web.UI.Page
{
    string sql;
    ...
    protected void BindGrid()
    {
        ...
        GridView1.DataSource = con.connect("select * from duplicate", "cont");
        GridView1.DataBind();
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            String sql = "delete from duplicate where fname='" + lcid.Text + "'";
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            string sql = "update duplicate set fname='" + uuname.Text + "',lname='" + upassword.Text + "',ddate='" + urepassword.Text + "',dnumber='" + ufname.Text + "',idate='" + ulname.Text + "',edate='" + ugender.Text + "',istate='" + umob.Text + "'  where  fname='" + uuname.Text + "'";
    ...
    protected void GridView1_RowDeleting1(object sender, GridViewDeleteEventArgs e)
    {
        ...
        try
        {
            string sql = "delete from duplicate where fname='" + lbl.Text + "'";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Insert")
        {
            ...
            try
            {
                string sql = "insert into duplicate values('" + uuname.Text + "','" + upassword.Text + "','" + urepassword.Text + "','" + ufname.Text + "','" + ulname.Text + "','" + ugender.Text + "','" + umob.Text + "')";
                if (con.ExceuteCommand(sql) >= 1)
                {
            ...
            {
                GridView1.DataSource = con.connect("select * from duplicate order by " + e.CommandArgument, "DeptSerch");
                GridView1.DataBind();
