...
public partial class admin1_ShowAllUser : System.Web.UI.Page
{
    string sql;
    ...
    protected void BindGrid()
    {
        ...
        GridView1.DataSource = con.connect("select * from newuser", "cont");
        GridView1.DataBind();
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        String sql = "delete from newuser where uname=" + lcid.Text;
...
string sql = "update newuser set uname='" + uuname.Text + "',password='" + upassword.Text + "',repassword='" + urepassword.Text + "',fname='" + ufname.Text + "',lname='" + ulname.Text + "',gender='" + ugender.Text + "',mob='" + umob.Text + "',email='" + uemail.Text + "' where  uname='" + uuname.Text + "'";
                        if (con.ExceuteCommand(sql) >= 1)
            {
                ...
                BindGrid();
                           ...
                           {
            Response.Write("<sript>alert('CURRENT RECORD NOT UPADATED successfully...');</script>");
                            }
        }
        catch
        {
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Insert")
        {
            ...
            string sql = "insert into newuser values('" + uuname.Text + "','" + upassword.Text + "','" + urepassword.Text + "','" + ufname.Text + "','" + ulname.Text + "','" + ugender.Text + "','" + umob.Text + "','" + uemail.Text + "')";
            if (con.ExceuteCommand(sql) >= 1)
            {
            ...
            {
                GridView1.DataSource = con.connect("select * from newuser order by " + e.CommandArgument, "DeptSerch");
                GridView1.DataBind();
